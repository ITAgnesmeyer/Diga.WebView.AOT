...
namespace Diga.WebView2.Wrapper.Implementation
{
    ...
    public class WebView2PointerInfoInterface : IDisposable
    {
        ...
        public tagRECT PointerDeviceRect { get => PointerInfo.GetPointerDeviceRect(); set => PointerInfo.SetPointerDeviceRect(value); }
        public tagRECT DisplayRect { get => PointerInfo.GetDisplayRect(); set => PointerInfo.SetDisplayRect(value); }
        public tagPOINT PixelLocation { get => PointerInfo.GetPixelLocation(); set => PointerInfo.SetPixelLocation(value); }
        public tagPOINT HimetricLocation { get => PointerInfo.GetHimetricLocation(); set => PointerInfo.SetHimetricLocation(value); }
        public tagPOINT PixelLocationRaw { get => PointerInfo.GetPixelLocationRaw(); set => PointerInfo.SetPixelLocationRaw(value); }
        public tagPOINT HimetricLocationRaw { get => PointerInfo.GetHimetricLocationRaw(); set => PointerInfo.SetHimetricLocationRaw(value); }
        ...
        public tagRECT TouchContact { get => PointerInfo.GetTouchContact(); set => PointerInfo.SetTouchContact(value); }
        public tagRECT TouchContactRaw { get => PointerInfo.GetTouchContactRaw(); set => PointerInfo.SetTouchContactRaw(value); }
