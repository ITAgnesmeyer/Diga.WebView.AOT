...
namespace Diga.WebView2.Wrapper.Implementation
{
    public class WebView2ExecuteScriptResultInterface : IDisposable //, ICoreWebView2ExecuteScriptResult
    {
        ...
        public int Succeeded => Iface.GetSucceeded();

        public string ResultAsJson => Iface.GetResultAsJson();
        ...
        public ICoreWebView2ScriptException Exception => Iface.GetException();
    }
}
