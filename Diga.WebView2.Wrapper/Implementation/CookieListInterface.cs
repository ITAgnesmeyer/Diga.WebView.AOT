...
{
    public class CookieListInterface : IDisposable
    {
        ...
        public CookieListInterface(ICoreWebView2CookieList iface)
        {
        ...
        private ICoreWebView2CookieList Iface
        {
            get
            {
                if (_Iface == null)
                {
                    Debug.Print(nameof(CookieListInterface) + "=>" + nameof(Iface) + " is null");

                    throw new InvalidOperationException(nameof(CookieListInterface) + "=>" + nameof(Iface) + " is null");
                }
