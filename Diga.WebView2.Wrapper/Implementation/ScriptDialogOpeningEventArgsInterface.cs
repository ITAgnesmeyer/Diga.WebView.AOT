    ...
    public class ScriptDialogOpeningEventArgsInterface : IDisposable
    {
        ...
        private ICoreWebView2ScriptDialogOpeningEventArgs Args
        {
            get
            {
                if (_Args == null)
                {
                    Debug.Print(nameof(ScriptDialogOpeningEventArgsInterface) + "=>" + nameof(Args) + " is null");

                    throw new InvalidOperationException(nameof(ScriptDialogOpeningEventArgsInterface) + "=>" + nameof(Args) + " is null");
                }
