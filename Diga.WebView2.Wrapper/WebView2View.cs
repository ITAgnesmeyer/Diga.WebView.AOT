...
namespace Diga.WebView2.Wrapper
{
    ...
    public class WebView2View : CoreWebView2_21Shim
    {
        ...
        private EventRegistrationToken _ServerCertificateErrorDetected;
        ...
        private void RegisterEvents()
        {
            ...
            ServerCertificateErrorDetectedEventHandler serverCertificateErrorDetectedHandler = new ServerCertificateErrorDetectedEventHandler();
            serverCertificateErrorDetectedHandler.ServerCertificateErrorDetected += OnServerCertificateErrorDetectedIntern;
            base.add_ServerCertificateErrorDetected(serverCertificateErrorDetectedHandler, out this._ServerCertificateErrorDetected);
        ...
        private void UnRegisterEvents()
        {
            try
            {
                ...
                EventRegistrationTool.UnWireToken(this._ServerCertificateErrorDetected, base.remove_ServerCertificateErrorDetected);
            }
            catch (Exception e)
            {
        ...
        public void PrintToPdf(string path, WebView2PrintSettings webView2PrintSettings)
        {
            PrintToPdfCompletedHandler handler = new PrintToPdfCompletedHandler();
            handler.Complete += (o, e) =>
            {
        ...
        //internal void AddRemoteObject(string name, ref object obj)
        //{
    ...
    //    public class WebView2View : WebView2View19Interface
    //    {
    ...
    //        public event EventHandler<ContextMenuRequestedEventArgs> ContextMenuRequested;
    //        public event EventHandler<PrintToPdfCompleteEventArgs> PrintToPdfCompleted;
    //        public WebView2View(ICoreWebView2_19 webView) : base(webView)
    //        {
    ...
    //        public new WebView2Settings Settings
    //        {
    //            get
    //            {
    //                var settings = (ICoreWebView2Settings8)base.Settings;
    //                return new WebView2Settings(settings);
    ...
    //        public async Task CapturePreviewAsync(Stream stream, COREWEBVIEW2_CAPTURE_PREVIEW_IMAGE_FORMAT imageFormat)
    //        {
    ...
    //        public async Task GetFavIconAsync(Stream stream, COREWEBVIEW2_CAPTURE_PREVIEW_IMAGE_FORMAT imageFormat)
    //        {
    ...
    //            base.AddHostObjectToScript(name, @object);
    ...
    //        //public void AddWebResourceRequestedFilter(string uri, COREWEBVIEW2_WEB_RESOURCE_CONTEXT context)
    //        //{
    //        //    base.AddWebResourceRequestedFilter(uri, (COREWEBVIEW2_WEB_RESOURCE_CONTEXT)context);
    //        //}


    //        //public void RemoveWebResourceRequestedFilter(string uri, COREWEBVIEW2_WEB_RESOURCE_CONTEXT context)
    //        //{
