    ...
    public class WebView2PrintSettings2Interface : WebView2PrintSettingsInterface
    {
        ...
        private ICoreWebView2PrintSettings2 PrinterSettings
        {
            get
            {
                ...
                {
                    Debug.Print(nameof(WebView2PrintSettings2Interface) + "." + nameof(PrinterSettings) + " is null");
                    throw new InvalidOperationException(nameof(WebView2PrintSettings2Interface) + "." + nameof(PrinterSettings) + " is null");
