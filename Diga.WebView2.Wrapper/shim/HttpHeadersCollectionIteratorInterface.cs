...
{
    public class HttpHeadersCollectionIteratorInterface :  IDisposable
    {
        ...
        private ICoreWebView2HttpHeadersCollectionIterator HeadersIterator
        {
            get
            {
                ...
                {
                    Debug.Print(nameof(HttpHeadersCollectionIteratorInterface) + "=>" + nameof(HeadersIterator) + " is null");

                    throw new InvalidOperationException(nameof(HttpHeadersCollectionIteratorInterface) + "=>" + nameof(HeadersIterator) + " is null");
                }
        ...
        public HttpHeadersCollectionIteratorInterface(ICoreWebView2HttpHeadersCollectionIterator headersIterator)
        {
        ...
        ~HttpHeadersCollectionIteratorInterface()
        {
