...
{
    public class ClientCertificateRequestedEventArgsInterface //: ICoreWebView2ClientCertificateRequestedEventArgs
    {
        ...
        private ICoreWebView2ClientCertificateRequestedEventArgs Args
        {
            get
            {
                if (_Args == null)
                {
                    Debug.Print(nameof(ClientCertificateRequestedEventArgsInterface) + "=>" + nameof(Args) + " is null");

                    throw new InvalidOperationException(nameof(ClientCertificateRequestedEventArgsInterface) + "=>" + nameof(Args) + " is null");
                }
        ...
        public ClientCertificateRequestedEventArgsInterface(ICoreWebView2ClientCertificateRequestedEventArgs args)
        {
