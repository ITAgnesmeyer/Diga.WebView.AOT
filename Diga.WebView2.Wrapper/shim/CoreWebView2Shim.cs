...
namespace Diga.WebView2.Wrapper.shim
{
    ...
    public class CoreWebView2Shim : IDisposable
    {
        ...
        private ICoreWebView2 WebView
        {
            get
            {
                if (_WebView == null)
                {
                    Debug.Print(nameof(CoreWebView2Shim) + "." + nameof(WebView) + " is null");
                    throw new InvalidOperationException(nameof(CoreWebView2Shim) + "." + nameof(WebView) + " is null");
        ...
        public CoreWebView2Shim(ICoreWebView2 webView)
        {
            if (webView == null)
