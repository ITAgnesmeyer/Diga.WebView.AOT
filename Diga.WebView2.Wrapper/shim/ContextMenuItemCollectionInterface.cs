...
namespace Diga.WebView2.Wrapper.shim
{
    ...
    public class ContextMenuItemCollectionInterface : IDisposable
    {
        ...
        public ContextMenuItemCollectionInterface(ICoreWebView2ContextMenuItemCollection iface)
        {
        ...
        private ICoreWebView2ContextMenuItemCollection Iface
        {
            get
            {
                if (_Iface == null)
                {
                    Debug.Print(nameof(ContextMenuItemCollectionInterface) + "=>" + nameof(Iface) + " is null");

                    throw new InvalidOperationException(nameof(ContextMenuItemCollectionInterface) + "=>" + nameof(Iface) + " is null");
                }
