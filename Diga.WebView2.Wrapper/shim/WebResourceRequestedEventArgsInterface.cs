...
{
    public class WebResourceRequestedEventArgsInterface : EventArgs, IDisposable
    {
        ...
        public ICoreWebView2WebResourceRequest Request => this.Iface.GetRequest();

        public ICoreWebView2WebResourceResponse Response { get => this.Iface.GetResponse(); set => this.Iface.SetResponse(value); }

        [return: MarshalAs(UnmanagedType.Interface)]
        public ICoreWebView2Deferral GetDeferral()
        {
            return this.Iface.GetDeferral();
        }

        public COREWEBVIEW2_WEB_RESOURCE_CONTEXT ResourceContext => this.Iface.GetResourceContext();
    }
}
