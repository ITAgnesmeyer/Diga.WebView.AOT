...
{
    public class CookieManagerInterface : IDisposable, ICoreWebView2CookieManager
    {
        ...
        public CookieManagerInterface(ICoreWebView2CookieManager iface)
        {
        ...
        private ICoreWebView2CookieManager Iface
        {
            get
            {
                if (_Iface == null)
                {
                    Debug.Print(nameof(CookieManagerInterface) + "=>" + nameof(Iface) + " is null");

                    throw new InvalidOperationException(nameof(CookieManagerInterface) + "=>" + nameof(Iface) + " is null");
                }
