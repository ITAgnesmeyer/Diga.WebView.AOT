    ...
    public class WebResourceRequestInterface : IDisposable
    {
        ...
        private ICoreWebView2WebResourceRequest Resource
        {
            get
            {
                ...
                {
                    Debug.Print(nameof(WebResourceRequestInterface) + "." + nameof(this.Resource) + " is null");
                    throw new InvalidOperationException(nameof(WebResourceRequestInterface) + "." + nameof(this.Resource) + " is null");
        ...
        public WebResourceRequestInterface(ICoreWebView2WebResourceRequest resource)
        {
