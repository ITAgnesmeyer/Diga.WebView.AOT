...
namespace Diga.WebView2.Wrapper.shim
{
    ...
    public class WebView2ScriptExceptionInterface : Exception, IDisposable //, ICoreWebView2ScriptException
    {
        ...
        public uint LineNumber => Iface.GetLineNumber();

        public uint ColumnNumber => Iface.GetColumnNumber();

        public string name => Iface.Getname();

        public override string Message => Iface.GetMessage();

        public string ToJson => Iface.GetToJson();
