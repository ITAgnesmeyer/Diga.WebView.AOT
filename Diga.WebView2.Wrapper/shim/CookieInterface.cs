...
namespace Diga.WebView2.Wrapper.shim
{
    ...
    public class CookieInterface : IDisposable
    {
        ...
        public CookieInterface(ICoreWebView2Cookie iface)
        {
        ...
        private ICoreWebView2Cookie Iface
        {
            get
            {
                if (_Iface == null)
                {
                    Debug.Print(nameof(CookieInterface) + "=>" + nameof(Iface) + " is null");

                    throw new InvalidOperationException(nameof(CookieInterface) + "=>" + nameof(Iface) + " is null");
                }
