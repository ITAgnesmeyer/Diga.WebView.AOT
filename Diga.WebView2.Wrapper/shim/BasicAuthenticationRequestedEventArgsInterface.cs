    ...
    public class BasicAuthenticationRequestedEventArgsInterface : IDisposable
    {
        ...
        private ICoreWebView2BasicAuthenticationRequestedEventArgs Args
        {
            get
            {
                if (_Args == null)
                {
                    Debug.Print(nameof(BasicAuthenticationRequestedEventArgsInterface) + "=>" + nameof(Args) + " is null");

                    throw new InvalidOperationException(nameof(BasicAuthenticationRequestedEventArgsInterface) + "=>" + nameof(Args) + " is null");
                }
